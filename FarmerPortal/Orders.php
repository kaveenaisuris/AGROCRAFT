...
<table>
        <tr id="protitle">
            <td>
                <div class="grp1">
                    ...
                    <div class="col2"><label class="text1" name="product_title" required>Premalal Silva</label>
            </td>
            </div>
            </div>
            <td>
        ...
        <tr id="protitle">
            <td>
                <div class="grp1">
                    ...
                    <div class="col2"><label class="text1" name="product_title" required>Hikkaduwa</label>
            </td>
            </div>
            </div>
            <td>
        ...
        <tr>  
            ...
            <td>
                ...
                <div class="grp2 movedown">
                    ...
                    <div class="col4">
                    <label class="text1" name="product_title" >8th March 2020</label>            </div>
     ...
     <div class="footer">
          ...
          <div class="patym"><img src="../Images/Website/paytm1.jpg" height="75px" width="125px"></div>
     </div><br><br>
     ...
     <div class="morefooter">
          ...
          <div class="call">
               ...
               <a href="#" style="color:black;">091 2254249</a>
          </div>
