...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
		...
		$query = "insert into doaregistration (doa_name,doa_phone,doa_addr,doa_comp,
		doa_license,doa_bank,doa_pan,doa_mail,doa_username,doa_password) 
		...
		echo "<script>window.open('DoALogin.php','_self')</script>";
