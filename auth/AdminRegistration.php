...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
		...
		$query = "insert into buyerregistration (admin_name,admin_phone,admin_addr,admin_comp,
		admin_license,admin_bank,admin_pan,admin_mail,admin_username,admin_password) 
