                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:35px;">
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="iconsmall.png" style="width: 28px; margin-bottom:  10px;"><b> Abishek </b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" style="margin-left:-9%;"><img src="phoneicon.jpg" style="width: 32px; margin-bottom:  10px;"><b> 0763471672 </b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="location.jpg" style="width: 32px; margin-bottom:  10px;"><b> Galle, Southern</b></h4>
                                </span>
                            </div>
                        </div>
					</div>
